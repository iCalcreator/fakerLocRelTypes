 ...
 * Class MediaTypes
 *
 * As found in https://www.iana.org/assignments/media-types/media-types.xhtml
 */
class MediaTypes extends FakerBase
{
    /**
    ...
    /**
     * A random selected application mediatype
     *
     * @return string
     */
    public function applicationMediaType() : string
    {
        static $APPLICATION = 'application/';
        return $APPLICATION . static::randomElement( static::$application );
    }
    ...
    /**
     * A random selected audio mediatype
     *
     * @return string
     */
    public function audioMediaType() : string
    {
        static $AUDIO = 'audio/';
        return $AUDIO . static::randomElement( static::$audio );
    }
    ...
    /**
     * A random selected font mediatype
     *
     * @return string
     */
    public function fontMediaType() : string
    {
        static $FONT = 'font/';
        return $FONT . static::randomElement( static::$font );
    }
    ...
    /**
     * A random selected image mediatype
     *
     * @return string
     */
    public function imageMediaType() : string
    {
        static $IMAGE = 'image/';
        return $IMAGE . static::randomElement( static::$image );
    }
    ...
    /**
     * A random selected message mediatype
     *
     * @return string
     */
    public function messageMediaType() : string
    {
        static $MESSAGE = 'message/';
        return $MESSAGE . static::randomElement( static::$message );
    }
    ...
    /**
     * A random selected model mediatype
     *
     * @return string
     */
    public function modelMediaType() : string
    {
        static $MODEL = 'model/';
        return $MODEL . static::randomElement( static::$model );
    }
    ...
    /**
     * A random selected multipart mediatype
     *
     * @return string
     */
    public function multipartMediaType() : string
    {
        static $MULTIPART = 'multipart/';
        return $MULTIPART . static::randomElement( static::$multipart );
    }
    ...
    /**
     * A random selected text mediatype
     *
     * @return string
     */
    public function textMediaType() : string
    {
        static $TEXT = 'text/';
        return $TEXT . static::randomElement( static::$text );
    }
    ...
    /**
     * A random selected video mediatype
     *
     * @return string
     */
    public function videoMediaType() : string
    {
        static $VIDEO = 'video/';
        return $VIDEO . static::randomElement( static::$video );
    }

    /**
     * A random selected mediatype of any type
     *
     * @return string
     */
    public function anyMediaType() : string
    {
        switch( static::numberBetween( 1, 9 )) {
            case 1 :
                return $this->applicationMediaType();
            case 2 :
                return $this->audioMediaType();
            case 3 :
                return $this->fontMediaType();
            case 4 :
                return $this->imageMediaType();
            case 5 :
                return $this->messageMediaType();
            case 6 :
                return $this->modelMediaType();
            case 7 :
                return $this->multipartMediaType();
            case 8 :
